...
const catStyles: Record<string, { gradient: string; color: string; shadow: string }> = {
  ...
  cloud: { gradient: "from-sky-500/10 to-sky-600/5", color: "#0ea5e9", shadow: "shadow-sky-500/20" },
  mensageria: { gradient: "from-teal-500/10 to-teal-600/5", color: "#14b8a6", shadow: "shadow-teal-500/20" },
