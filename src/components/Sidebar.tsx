...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 z-40 h-full w-64 flex flex-col bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white">
      <Link
        href="/"
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-6 scrollbar-thin scrollbar-thumb-white/10">
        <p className="text-xs font-semibold uppercase tracking-widest text-white/40 mb-4 px-2">
          Categorias
        </p>
